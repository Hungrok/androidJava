...
public class MainActivity extends AppCompatActivity {
    ...
    protected void doAirplane(){
        Intent it1 = new Intent(this, Sub1Activity.class) ;
        startActivity(it1) ;
    }
    protected void doSentiment(){
        Intent it1 = new Intent(this, Sub2Activity.class) ;
        startActivity(it1) ;
    }
    protected void doMenu(){
        Intent it1 = new Intent(this, Sub3Activity.class) ;
        startActivity(it1) ;
    }
}
